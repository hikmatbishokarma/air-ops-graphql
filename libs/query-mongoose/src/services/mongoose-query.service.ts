  ...
  implements QueryService<Entity, DeepPartial<Entity>, DeepPartial<Entity>>
{
  ...
  async aggregate(
    ...
    const { aggregate, filterQuery, options } =
      this.filterQueryBuilder.buildAggregateQuery(aggregateQuery, filter);
