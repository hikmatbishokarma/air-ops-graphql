...
> implements QueryService<DTO, C, U>
{
  ...
  addRelations<Relation>(
    ...
    return this.assembler.convertAsyncToDTO(
      this.queryService.addRelations(
        relationName,
        id,
        relationIds,
  ...
  deleteOne(id: number | string, opts?: DeleteOneOptions<DTO>): Promise<DTO> {
    return this.assembler.convertAsyncToDTO(
      this.queryService.deleteOne(id, this.convertFilterable(opts)),
    );
  }
  ...
  getById(id: string | number, opts?: GetByIdOptions<DTO>): Promise<DTO> {
    return this.assembler.convertAsyncToDTO(
      this.queryService.getById(id, this.convertFilterable(opts)),
    );
  }

  query(query: Query<DTO>): Promise<DTO[]> {
    return this.assembler.convertAsyncToDTOs(
      this.queryService.query(this.assembler.convertQuery(query)),
    );
  }
  ...
  async queryRelations<Relation>(
    ...
    if (Array.isArray(dto)) {
      ...
      const relationMap = await this.queryService.queryRelations(
        RelationClass,
        relationName,
        entities,
        query,
    ...
    return this.queryService.queryRelations(
      RelationClass,
      relationName,
  ...
  async countRelations<Relation>(
    ...
    if (Array.isArray(dto)) {
      const entities = this.assembler.convertToEntities(dto);
      const relationMap = await this.queryService.countRelations(
        RelationClass,
        relationName,
        entities,
        filter,
    ...
    return this.queryService.countRelations(
      RelationClass,
      relationName,
      this.assembler.convertToEntity(dto),
      filter,
  ...
  async findRelation<Relation>(
    ...
    if (Array.isArray(dto)) {
      const entities = this.assembler.convertToEntities(dto);
      const relationMap = await this.queryService.findRelation(
        RelationClass,
        relationName,
        entities,
        opts,
    ...
    return this.queryService.findRelation(
      RelationClass,
      relationName,
      this.assembler.convertToEntity(dto),
    );
  ...
  removeRelations<Relation>(
    ...
    return this.assembler.convertAsyncToDTO(
      this.queryService.removeRelations(
        relationName,
        id,
        relationIds,
        this.convertModifyRelationsOptions(opts),
  ...
  setRelations<Relation>(
    ...
    return this.assembler.convertAsyncToDTO(
      this.queryService.setRelations(
        relationName,
        id,
        relationIds,
        this.convertModifyRelationsOptions(opts),
  ...
  private convertModifyRelationsOptions<Relation>(
    ...
    return {
      filter: this.assembler.convertQuery({
