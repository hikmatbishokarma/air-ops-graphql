...
import { FilterFieldComparison } from 'src/interfaces/filter-field-comparison.interface';
import { Filter, FilterComparisons } from 'src/interfaces/filter.interface';
...
export class WhereBuilder<Entity extends Document> {
  constructor(
    ...
    readonly comparisonBuilder: ComparisonBuilder<Entity> = new ComparisonBuilder(
      Model,
    ),
  ) {}
