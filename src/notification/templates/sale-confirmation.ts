...
//  * @param {object} quote - The complete quote object with all nested details.
...
//     const paxIfno = quote.passengerInfo?.sectors?.find(
...
//             margin-bottom: 32px;
//         }
//         .logo-container { width: 64px; height: auto; margin-right: 12px; }
//         .logo-container img { max-width: 100%; height: auto; }
//         .header-text { font-size: 0.75rem; margin-top: 4px; }
...
//         .route-point-code { font-size: 1.25rem; font-weight: 800; color: var(--color-text-dark); }
...
//         <div class="header-left flex items-start">
...
//         <h2 class="section-title uppercase tracking-wider text-sm" style="color: ${'#4338ca'}; border-bottom: 1px solid ${'#c7d2fe'};">Booking Summary</h2>
//         <div class="detail-group">
//             <div class="detail-item">
//                 <span class="detail-label">Booking Date</span>
//                 <span class="detail-value">${moment(createdAt).format('DD MMMM, YYYY')}</span>
//             </div>
//             <div class="detail-item">
//                 <span class="detail-label">Aircraft</span>
//                 <span class="detail-value">${aircraftDetail?.name || 'N/A'} (${aircraftDetail?.code || 'N/A'})</span>
//             </div>
//         </div>
//     </section>
...
//                 Trip ${index + 1}: ${item?.source?.code || 'N/A'} to ${item?.destination?.code || 'N/A'}
//             </h2>
...
//                     </div>
//                     <p class="flight-card-duration" style="margin-top: 4px;">Aircraft: <span class="table-content-text">${aircraftDetail?.name || 'N/A'}</span></p>
//                 </div>
...
//                         <p class="route-point-time">${item.depatureTime || 'N/A'}</p>
//                     </div>

//                     <!-- Icon / Line -->
//                     <div class="route-line">
//                         <svg class="icon" viewBox="0 0 24 24">
//                             <path d="M22 17.5a1 1 0 01-1 1H3a1 1 0 01-1-1v-12A1.5 1.5 0 013.5 4h17A1.5 1.5 0 0122 5.5v12z"></path>
...
//                         <p class="route-point-time">${item.arrivalTime || 'N/A'}</p>
//                     </div>
//                 </div>
//             </div>
...
//     <!--
//     <section style="margin-top: 48px; padding-top: 24px; border-top: 1px solid var(--color-border);">
//         <h3 class="section-title" style="font-size: 1.125rem;">Price Summary</h3>
//         ... dynamic price tables here ...
//     </section>
//     -->
// </div>
// </body>
